...
var hero, monster, rope, ground, people;
var sound, state;

function preload() {
  bg = loadImage("background.png");
  people = loadImage("shockedPeople.png")
  sound = loadSound("avengersTheme.mp3")
}
...
function draw() {
  ...
  textSize(30)
    text("Drag The Mouse To Put the Superwoman In Action And Save The Town!!",220,30)

    if(state===1){ 
      textSize(40) 
      text("Yay, champ!! You saved your town from the monster! ",300,300) 
    }
